...
OUTPUT_PATH = SystemPath(__file__).parent.parent / "food.py"
TYPE_KEY = "foods"
...
def build_enum(entries, version):
    ...
    lines = [
        ...
        "    stack_size: int",
        "",
        "    def __new__(cls, num_id: int, string_id: str, display_name: str, food_points: int, saturation: float, stack_size: int) -> Food:",
